...
const textVariants = {
  emphasis: (props: ThemeComponentProps<ChakraTheme>) => ({
    color: mode('orange.500', 'cyan.400')(props),
  }),
  ...
  accent: (props: ThemeComponentProps<ChakraTheme>) => ({
    color: mode('black.400', 'cyan.400')(props),
  }),
...
const theme = extendTheme({
  ...
  components: {
    ...
    Button: {
      variants: {
        outline: (props: Dict<any> | StyleFunctionProps) => ({
          borderColor: mode('black.400', 'cyan.400')(props),
        }),
        outlineAlternative: (props: Dict<any>) => ({
          borderWidth: '1px',
          borderRadius: 0,
    ...
    Icon: {
      variants: {
        accent: (props: Dict<any> | StyleFunctionProps) => ({
    ...
    Divider: {
      variants: {
        solid: (props: Dict<any> | StyleFunctionProps) => ({
          borderColor: mode('gray.800', 'gray.400')(props),
          marginLeft: 'auto',
          marginRight: 'auto',
        }),
